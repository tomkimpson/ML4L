...
def load_and_process_data(input_file,train_condition,test_condition):
    ...
    """Load the data, normalize, split into train/test and features/targets"""
    ...
    #Separate into train/valid/test based on time
    ...
    x_valid = features_normed[idx_valid] 
    y_valid = target_normed[idx_valid]
    ...
    return x_train,y_train,x_valid,y_valid,x_test,y_test,target.mean(),target.std(),results_df
    
    
    

def train_NN(x,y,x_val, y_val,epochs,batch_size,use_validation_data):    
